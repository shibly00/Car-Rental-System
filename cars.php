			...
			<div class="col-md-8">
				<div class="content-holder">
					<ul class="list-inline mt-30">
						...
						<li class="list-inline-item"><a class="btn btn-main" href="cars.php">Cars</a></li>
					</ul>
				</div>
			</div>
		</div>
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
                                        ...
                                        <form action="cars_controller.php?reg_no=<?php echo $row['reg_no'] ?>" method="post" enctype="form-data">
									...
									<div class="row">
										<div class="col-md-6 text-center mx-auto">
											<div class="404-content">
												<h1 class="display-1 pt-1 pb-2">No Cars Added Yet</h1>
