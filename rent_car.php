				...
				<div class="product-grid-list">
					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['drop'])) {
							...
							$sql="SELECT * FROM vehicle WHERE $drop='$search'";
						...
						<div class="col-sm-12 col-lg-4 col-md-6">
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title"><a href="single.html"><?php echo $row['model'] ?></a></h4>
										<ul class="list-inline product-meta">
											<li class="list-inline-item">
												<a href="single.html"><i class="fa fa-folder-open-o"></i>Mileage : <?php echo $row['mileage'] ?>km</a>
											</li>
											<li class="list-inline-item">
												<a href="#"><i class="fa fa-calendar"></i><?php echo $row['year'] ?></a>
											</li>
										</ul>
										<ul class="list-inline product-meta">
											<li class="list-inline-item">
												<a href="single.html"><i class="fa fa-folder-open-o"></i><?php echo $row['colour'] ?></a>
											</li>
											<li class="list-inline-item">
												<a href="#"><i class="fa fa-calendar"></i><?php echo $row['fuel_type'] ?></a>
											</li>
										</ul>
										<p class="card-text"><?php echo $row['description'] ?></p>
										<h4 class="card-title"><a href="single.html">৳ <?php echo $row['rent'] ?></a> (per day)</h4>
										<br>
										...
										<?php
											if ($row['res_id'] == NULL || $row['res_id'] == null || $row['res_id'] == 0) {
										?>
												<p class="card-text">Pick the date and enter number of days you want to rent for from that date and click go!</p>
												<form action="rent_car_controller.php?reg_no=<?php echo $row['reg_no'] ?>" method="post" enctype="form-data">
													<input type="date" name="date" required><br>
													Rent for <input type="number"name="days" max="30" min="1" required> days <button type="submit" name="upload" value="Submit" class="nav-link text-white add-button">Go!</button>
												</form>
										<?php
											} else {
										?>
												<p class="card-text">Sorry, this car is currently rented by another user!</p>
										<?php
											}
										?>
									</div>
